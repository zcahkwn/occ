...
class DataShare:
    ...
    def create_shard(self, shard_size: int) -> list[int]:
        ...
        assert (
            shard_size <= self.total_number
        ), "Shard size should be less than total number of data points"
...
if __name__ == "__main__":
    ...
    print(set(alice_shard + bob_shard + charlie_shard) == set(new_mpc.secret_set))
